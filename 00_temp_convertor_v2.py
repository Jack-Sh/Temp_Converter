...
class Converter:
    ...
    def __init__(self):
        ...
        self.to_history_button = Button(self.button_frame, text="History / Export", bg="#049C99", fg=button_fg, font=button_font, width=12, state=DISABLED, command=lambda: self.to_history(self.all_calculations))
